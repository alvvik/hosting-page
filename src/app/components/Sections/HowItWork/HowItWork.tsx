...
export default function HowItWork() {
  return (
    <section className="px-4 py-8 sm:px-6 lg:px-8" id="jaktodziala">
      ...
      <div className="grid gap-4 p-4 md:grid-cols-2 md:gap-6 md:max-w-5xl md:mx-auto md:items-start">
        {steps.map((s, i) => (
          <article
            key={i}
            className="rounded-lg ring ring-border bg-surface p-4 shadow-sm h-32 "
          >
            ...
            <p className="text-fluid-small leading-6 text-text-muted">
              {s.desc}
            </p>
          </article>
        ))}
